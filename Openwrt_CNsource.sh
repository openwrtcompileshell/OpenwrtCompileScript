...
source_download_openwrt() {
		...
		read  -p "请输入你要下载的源代码:" Download_source_openwrt
			case "$Download_source_openwrt" in
				1)
				git clone https://gitee.com/OpenwrtChinaSource/openwrt-coolsnowwolf.git lede
				;;
				2)
				git clone https://gitee.com/OpenwrtChinaSource/lede-coolsnowwolf.git lede
				;;
				3)
				git clone https://gitee.com/OpenwrtChinaSource/openwrt-Lienol.git lede
				;;
				4)
				git clone -b lede-17.01 https://gitee.com/OpenwrtChinaSource/openwrt.git lede
				;;
				5)
				git clone -b openwrt-18.06 https://gitee.com/OpenwrtChinaSource/openwrt.git lede
				;;
				6)
				git clone -b openwrt-19.07 https://gitee.com/OpenwrtChinaSource/openwrt.git lede
				;;
				7)
				git clone  https://gitee.com/OpenwrtChinaSource/openwrt.git lede
				;;
				0)
				exit
				;;
